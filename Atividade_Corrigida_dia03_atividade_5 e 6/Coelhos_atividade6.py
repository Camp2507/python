...
# ao fim de um ano, quantos casais de coelhos estão no pátio? Escreva um programa para calcular a quantidade de coelhos em um ano.
...
for i in range(meses):
    ...
    print("O número de casal de coelhos no mês", i+1, " é: ", casal)
